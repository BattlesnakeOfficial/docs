...
The location of hazardous squares are found in the API on the [board object](api/objects/board) listed under `hazards`, and are visible on the board as a darker-grey square.
